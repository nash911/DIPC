...
def main(args):
    ...
    ppo = PPOContinuous(env=env, render_env=env, hl1_size=params['hl1_size'],
    ...
    _ = ppo.final_evaluation(num_episodes=10, episode_len=params['episode_len'])


if __name__ == '__main__':
    parser = argparse.ArgumentParser(description='PPO Evaluation for DIPCart Task')
